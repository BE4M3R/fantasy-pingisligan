-- Award the fixture-win bonus only to fantasy players who have an imported
-- appearance in that fixture. The locked club snapshot still determines which
-- club the player represented, so later roster imports cannot rewrite history.
