-- In a won match, award set points for the winning margin instead of every
-- set won. Players who lose still receive one point for each set they won.
-- Doubles keep sharing that set-points component between the two players.
