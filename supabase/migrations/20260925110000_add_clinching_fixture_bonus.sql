-- Award the player or pair that wins the final scored submatch for the club
-- recorded as winning a team fixture. Singles clinchers earn two points;
-- doubles clinchers earn one point per player.
...
begin
  ...
  clinching_bonus as (
    ...
    join public.player_submatch_results as results
      on results.stupa_submatch_id = clinching_submatches.stupa_submatch_id
    where results.won
