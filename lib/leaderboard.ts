...
// Live result imports happen outside Next.js, so this read must not use the
// application data cache. Otherwise global standings can lag behind private
// leagues even though both RPCs read the same scored gameweek totals.
async function readGlobalLeaderboard(url: string, key: string) {
